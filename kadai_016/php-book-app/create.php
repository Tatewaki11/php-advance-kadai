...
if (isset($_POST['submit'])) {
  try {
    ...
    // $stmt_insert->bindValue(':updated_at', $_POST['updated_at'], PDO::PARAM_INT);
      ...
      <article class="registration">
        ...
        <form action="create.php" method="post" class="registration-form">
          <div>
            ...
            <input tyoe="number" name="stock_quantity" min="0" max="100000000" required>
            ...
            <input type="number" name="updated_at" min="0" max="100000000" required> -->
          </div>
